...
决策与实现记录以 GitHub 为家，仓库文档只留稳定内容。先例与决策记录见 #296；架构权威来源是 map issue #331（pinned）。

### 归口

| 内容 | 归属 |
|------|------|
| 设计决策、方案取舍、暂缓/否决的 rationale | GitHub issue；架构类（总览/概念模型/基础决策）进 map #331，具体决策的裁定现场是对应 issue/PR |
